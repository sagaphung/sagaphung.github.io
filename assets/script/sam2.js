...
function unhideLightbox12() {
	unhideLightbox("letter12");
}

document.getElementById("letter-12").onclick = unhideLightbox12;


function unhideLightbox1() {
	// TODO: Look in q2.html to see what the id for the lightbox div for the first picture, and call unhideLightbox
	unhideLightbox("letter1");
}

document.getElementById("letter-1").onclick = unhideLightbox1;

function unhideLightbox2() {
	unhideLightbox("letter2");
}

document.getElementById("letter-2").onclick = unhideLightbox2;


function unhideLightbox3() {
	unhideLightbox("letter3");
}

document.getElementById("letter-3").onclick = unhideLightbox3;

function unhideLightbox4() {
	// TODO: Look in q2.html to see what the id for the lightbox div for the first picture, and call unhideLightbox
	unhideLightbox("letter4");
}

document.getElementById("letter-4").onclick = unhideLightbox4;

function unhideLightbox5() {
	unhideLightbox("letter5");
}

document.getElementById("letter-5").onclick = unhideLightbox5;

function unhideLightbox6() {
	unhideLightbox("letter6");
}

document.getElementById("letter-6").onclick = unhideLightbox6;

function unhideLightbox7() {
	unhideLightbox("letter7");
}

document.getElementById("letter-7").onclick = unhideLightbox7;

function unhideLightbox8() {
	unhideLightbox("letter8");
}

document.getElementById("letter-8").onclick = unhideLightbox8;

function unhideLightbox9() {
	unhideLightbox("letter9");
}

document.getElementById("letter-9").onclick = unhideLightbox9;

function unhideLightbox10() {
	unhideLightbox("letter10");
}

document.getElementById("letter-10").onclick = unhideLightbox10;

function unhideLightbox11() {
	unhideLightbox("letter11");
}

document.getElementById("letter-11").onclick = unhideLightbox11;
